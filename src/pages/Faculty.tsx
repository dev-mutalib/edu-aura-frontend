      ...
      <div className="min-h-screen pt-16 relative">
        ...
        <Container>
          <div className="flex flex-col items-center justify-center mt-20">
            ...
            <p className="text-muted-foreground animate-pulse">Loading faculty...</p>
          </div>
        </Container>
      </div>
    );
      ...
      <section className="relative py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 mb-6 animate-fade-in">
            ...
            <span className="text-sm text-primary font-medium">Meet Our Team</span>
          </div>
      ...
      <Container>
        ...
        <section className="relative py-16 border-t border-border/30">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { value: '200+', label: 'Faculty Members', gradient: 'from-primary to-secondary' },
              { value: '85%', label: 'Ph.D. Holders', gradient: 'from-secondary to-accent' },
              { value: '500+', label: 'Publications', gradient: 'from-accent to-primary' },
              { value: '15:1', label: 'Student Ratio', gradient: 'from-primary to-accent' },
            ].map((stat, index) => (
